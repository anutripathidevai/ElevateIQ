...
import { ArrowLeft, Bell, Clock, Gauge } from "lucide-react";
import { ACCENT_STYLES, type AccentKey } from "@/lib/navigation";
import { cn } from "@/lib/utils";
import type { CDModuleMeta } from "../types";

/**
 * Placeholder for catalog modules that don't yet have authored content. Renders
 * the known metadata (so the page is still useful) and clearly marks the module
 * as coming soon.
 */
    ...
    <div className="space-y-6">
      ...
      <div className="rounded-2xl border border-dashed border-border bg-muted/20 p-8 text-center">
        ...
        <h2 className="mt-4 text-lg font-semibold">
          This module is in the works
        </h2>
        <p className="mx-auto mt-2 max-w-md text-sm text-muted-foreground">
          We&apos;re authoring a full deep dive for{" "}
          <span className="font-medium text-foreground">{meta.title}</span> —
          crisp concepts, diagrams, senior-level focus, and interview-ready
          takeaways. In the meantime, explore the published modules in this
          track.
        </p>
        <Link
          href="/learning/cloud-devops"
