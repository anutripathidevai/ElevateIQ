...
export const DSA_TOPICS: DsaTopicMeta[] = [
  {
    ...
    description:
      "Master the array manipulations and hashing tricks that underpin almost every other topic — frequency maps, prefix sums, in-place transformations, and hash-backed data-structure design.",
    status: "published",
    accent: "blue",
    iconKey: "arrays",
    difficulty: "Medium",
  ...
  },
  {
    ...
    problemCount: 12,
    durationHours: 7,
    tags: ["Intervals", "Sorting", "Greedy", "Scheduling", "Heap", "Sweep Line"],
  },
  {
    slug: "sliding-window",
    name: "Sliding Window",
  ...
  },
  {
    ...
    description:
      "Generate permutations, combinations, and subsets — and prune the search tree — with the choose/explore/unchoose template, all the way to board search and advanced pruning.",
    status: "published",
    accent: "violet",
