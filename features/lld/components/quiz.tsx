...
import type { LLDQuizItem } from "../types";

/**
 * Interactive multiple-choice quiz for LLD entries. Learners pick an answer per
 * question, get immediate right/wrong feedback with an explanation, and see a
 * running score. Fully client-side; no answers ship as visible text before
 * selection.
 */
export function Quiz({ items }: { items: LLDQuizItem[] }) {
