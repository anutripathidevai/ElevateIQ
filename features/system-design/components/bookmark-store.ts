...
/**
 * Client-side bookmark + recently-viewed tracking for System Design questions,
 * backed by localStorage (mirrors `lib/progress-store.ts`). Works fully in guest
 * mode — no database or sign-in required.
 */
import { useSyncExternalStore } from "react";

const BOOKMARK_KEY = "elevateiq:sd:bookmarks:v1";
const RECENT_KEY = "elevateiq:sd:recent:v1";
const EVENT = "elevateiq:sd:store";
