...
/**
 * Placeholder shown for catalog questions that don't yet have authored content.
 * Renders the known metadata (so the page is still useful) and clearly marks the
 * question as coming soon.
 */
    ...
    <div className="space-y-6">
      ...
      <div className="rounded-2xl border border-dashed border-border bg-muted/20 p-8 text-center">
        ...
        <p className="mx-auto mt-2 max-w-md text-sm text-muted-foreground">
          We&apos;re authoring a full 25-section breakdown for{" "}
          <span className="font-medium text-foreground">{meta.title}</span> —
          requirements, capacity math, an interactive architecture diagram, deep
          dives, tradeoffs, and interview tips. In the meantime, explore the
          published questions in this tier.
        </p>
        <Link
          href="/learning/system-design"
          className={cn(
