...
export const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    href: "/ai-labs",
    items: [
      { href: "/ai-labs", label: "All Labs", icon: FlaskConical },
      {
      ...
      { href: "/ai-labs/rag-pipeline", label: "RAG Pipeline", icon: Layers },
      { href: "/ai-labs/tool-calling", label: "Tool Calling", icon: Network },
      { href: "/ai-labs/ai-agent", label: "AI Agent", icon: Brain },
      { href: "/ai-labs/production-ai", label: "Production AI", icon: Sparkles },
    ],
  },
  {
    id: "career",
